...
impl<const N: usize> SpinChain<N> {
    ...
    //     let chain = SpinChain::<N>::construct_chain();
    //     // let chain_bond_rep = SpinChain::construct_bond_rep(chain.clone());
    ...
    // fn construct_bond_rep(chain: Vec<i8>) -> [char;N] {
